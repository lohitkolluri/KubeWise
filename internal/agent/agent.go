...
func NewAgent(s *store.Store, promAddr string, interval time.Duration, llmKey, llmModel string, remCfg remediator.RemediationConfig) (*Agent, error) {
	// Collector
...
func (a *Agent) runOnce() {
	...
	// 2. Predict anomalies (statistical)
