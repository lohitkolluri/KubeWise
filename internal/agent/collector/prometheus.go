...
func queries() []promQuery {
	return []promQuery{
		...
		{Name: "crashloop", Query: `kube_pod_container_status_waiting{reason="CrashLoopBackOff"}`},
		{Name: "imagepull_backoff", Query: `kube_pod_container_status_waiting{reason="ImagePullBackOff"}`},
